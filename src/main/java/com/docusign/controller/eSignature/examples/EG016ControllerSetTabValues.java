...
public class EG016ControllerSetTabValues extends AbstractEsignatureController {
    ...
    protected Object doWork(WorkArguments args, ModelMap model,
        ...
        EnvelopeDefinition envelope = makeEnvelope(linkToMap, signerEmail, signerName);
    ...
    private static EnvelopeDefinition makeEnvelope(String linkToMap, String signerEmail, String signerName) throws IOException {
        ...
        textSalary.setValue("click here to view the map");
        ...
        //textSalary.setUnderline(true);
        //textSalary.setShared("bbbbbbbbbbbbbbbbbbbbbbb");
        ...
        salaryCustomField.setValue("gggggggggggggggggggggggg");
        //salaryCustomField.setTooltip("https://www.google.com");
